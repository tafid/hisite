    ...
    <p>It is prohibited to use standard API for stealing domains that are released (drops). If you violate this rule, your account will be blocked.
        If you are interested in domain interception, use the <a href="/en/resellers/intercept">specialized API</a>.
    </p>
    ...
    <p>Contact information and Whois information must be filled correctly. Accounts with false information can be blocked until correct information of the account/domain names’ owner is received. The user is obliged to present the scan copies of a passport or some other documents asked upon the registrar’s request within the shortest time, but not later than in 48 hours. If the demand is not fulfilled, the registrar is entitled to block the domain names and account until all circumstances are clarified.</p>
    ...
    <p>The following list can be amended / supplemented without notice.<br>
        Your contact information from the hosting account has to be indicated correctly. Accounts with incorrect information can be blocked until
    ...
    <br><br>
    <hr class="small"/>
    <p class="text-muted">* Websites using "children images" are sites that have pictures and/or videos that look like/create the
        impression of child pornography, despite the fact that the models used in the pictures and videos are adult (18 years and older).</p><p>
    </p>