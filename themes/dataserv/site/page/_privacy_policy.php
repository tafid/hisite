<p>
    ...
    The following rules describe how AHnames.com collects, uses and discloses the personal and non-personal information
    you provide while using the "Site".
</p>
<p>
    By using AHnames.com, you agree to accept the practices described in this Privacy Policy.
    This Privacy Policy is subject to AHnames’ Terms &amp; Conditions. If you have any questions concerning the Privacy
    Policy, please <a href="/site/contact">Contact Us</a>.
</p>
...
<ul>
    ...
    <li>Your name, postal address, email address, telephone numbers and fax numbers of the technical and administrative
        contacts for the registered domain names;
    </li>
    <li>the full hostnames and internet protocol (IP) addresses of at least two nameserver
...
<p>No personally identifiable information will be linked to such aggregated demographic information that is shared with
    third parties.
</p>
...
<p>We may use such information for marketing purposes, and to send information to you that we believe might be of
    interest.</p>
<p>In addition, such information may be shared with partners, market researchers and other third parties on an
...
<p>
    We do not extract information about individual users from Cookies. Also, when Cookies are disabled, certain services
...
<p>
    If you provide your name for a promotional offer, to enter a sweepstakes or contest, and win a prize, we will post a
    winner's list online, and will file your name with state agencies if required by law.
</p>
