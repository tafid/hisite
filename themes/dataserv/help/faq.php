<?php
$this->title = Yii::t('hisite/faq', 'FAQ');
$this->registerJs("
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="faq-categories">
                <ul>
                    <li class="active"><a href="#dns" data-toggle="tab"><?= Yii::t('hisite/faq', 'DNS Server setup') ?>
                            <span class="badge">3</span></a></li>
                    <li><a href="#transfer" data-toggle="tab"><?= Yii::t('hisite/faq', 'Transfer') ?> <span
                                class="badge">4</span></a></li>
                    <li><a href="#reseller" data-toggle="tab"><?= Yii::t('hisite/faq', 'For resellers') ?> <span
                                class="badge">1</span></a></li>
                    <li><a href="#hosting" data-toggle="tab"><?= Yii::t('hisite/faq', 'Hosting') ?> <span class="badge">3</span></a>
                    </li>
                    <li><a href="#verification" data-toggle="tab"><?= Yii::t('hisite/faq', 'Verification') ?> <span
                                class="badge">2</span></a></li>
                    <li><a href="#other" data-toggle="tab"><?= Yii::t('hisite/faq', 'Other') ?> <span
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><i class="indicator fa fa-minus-square-o pull-left"></i><a
                                            ...
                                            href="#collapse1"><?= Yii::t('hisite/faq', 'NS Server installation') ?></a>
                                    </h4>
                                </div>
