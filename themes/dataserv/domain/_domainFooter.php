    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="contactmethod darkgray">
                <h5><?= Yii::t('app', 'Android App') ?></h5>
                <p>Times democracy change movements process medicine. Sustainable future.</p>
                <div class="text-center"><a class="mtr-btn button-raised ripple has-ripple" href="javascript:void(0)"><?= Yii::t('app', 'View more') ?></a></div>
            </div>
        </div>

        <div class="col-sm-4">
            <div class="contactmethod blue">
                <h5><?= Yii::t('app', 'Whois lookup') ?></h5>
